...
for(i in 1:n){
  ...
  #draw p
    p[i] = rbeta(1, shape1 = 0.2, shape2 = 0.2)
...
pdf(file = 'EVPI_hists_exp_norm_unif_p_beta_0_2.pdf', width = 7, height = 2.6)
ylim = c(0, max(h.u.0$counts, h.n.0$counts, h.e.0$counts))
...
pdf(file = 'EVPI_hists_exp_norm_unif_p_beta_0_2_raw.pdf', width = 7, height = 2.6)
par(mfrow = c(1,3), mar = c(1,1.2,1,1), oma= c(3,3,0,0))
lw = 1; ca=1.1; cl = 1.2;
